...
```{r}
options(width=80)
knitr::opts_chunk$set(echo=TRUE,out.width=45,tidy=T,fig.show="hide",tidy.opts=list(width.cutoff=45),dev="jpeg")
...
ggplot(data=disp.hetero, aes(x=Age, y=Procrustes.Variance, fill=Model)) +
  ...
  # scale_fill_manual(values = carto_pal(6,name = "ArmyRose")) +
  # scale_color_manual(values = carto_pal(6,name = "ArmyRose")) +
